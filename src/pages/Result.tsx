...
const Result: React.FC = () => {
  ...
  return (
    <div className={classes.main}>
      ...
      <TeX
        block
        math="\rho_i\frac{\partial u_i}{\partial t} + \rho_i u_i\frac{\partial u_i}{\partial x} + \frac{\partial \rho_i^{\gamma_i}}{\partial x}=\frac{\partial}{\partial x}\left(v_{i1}\frac{\partial u_1}{\partial x} + v_{i2}\frac{\partial u_2}{\partial x}\right) + (-1)^{i+1}a(u_2-u_1)"
      />
